...
!!! warning
    ...
    Du solltest daher __umgehend__ das `root` Passwort ändern, sobald
...
Um deinen HuCon mit dem WLAN AP deines Heimnetzwerks (also eurem
...
!!! warning
    ...
    Diese Datensicherungsdatei musst du irgendwo speichern, wo du
